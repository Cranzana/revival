...
// Validate ../../../app/(marketing)/pricing/page.tsx
{
	...
	const handler =
		{} as typeof import("../../../app/(marketing)/pricing/page.js");
	type __Check = __IsExpected<typeof handler>;
	// @ts-ignore
	type __Unused = __Check;
}
...
// Validate ../../../app/(platform)/dashboard/page.tsx
{
	...
	const handler =
		{} as typeof import("../../../app/(platform)/dashboard/page.js");
	type __Check = __IsExpected<typeof handler>;
	// @ts-ignore
	type __Unused = __Check;
}

// Validate ../../../app/(platform)/learn/page.tsx
{
	type __IsExpected<Specific extends AppPageConfig<"/learn">> = Specific;
	const handler = {} as typeof import("../../../app/(platform)/learn/page.js");
	type __Check = __IsExpected<typeof handler>;
	// @ts-ignore
	type __Unused = __Check;
}

// Validate ../../../app/(platform)/proxy/page.tsx
{
	type __IsExpected<Specific extends AppPageConfig<"/proxy">> = Specific;
	const handler = {} as typeof import("../../../app/(platform)/proxy/page.js");
	type __Check = __IsExpected<typeof handler>;
	// @ts-ignore
	type __Unused = __Check;
}

// Validate ../../../app/campus/[tenant]/page.tsx
{
	type __IsExpected<Specific extends AppPageConfig<"/campus/[tenant]">> =
		Specific;
	const handler = {} as typeof import("../../../app/campus/[tenant]/page.js");
	type __Check = __IsExpected<typeof handler>;
	// @ts-ignore
	type __Unused = __Check;
}
