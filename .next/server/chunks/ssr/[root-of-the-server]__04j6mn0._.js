module.exports = [
	...
	(a) => {
		...
		var b = a.i(51432),
			...
			d = a.i(49253),
			e = a.i(19959);
		function f({ children: a, href: c, kind: g = "primary" }) {
			let h = [
				e.default.button,
				"secondary" === g ? e.default.buttonSecondary : "",
				"ghost" === g ? e.default.buttonGhost : "",
			]
				.filter(Boolean)
				.join(" ");
			return c
				? (0, b.jsx)(d.default, { href: c, className: h, children: a })
				: (0, b.jsx)("button", { className: h, children: a });
		}
		let g = [
			{
				name: "Campus Starter",
		...
		a.s(
			[
				...
				function () {
					return (0, b.jsx)("main", {
						className: e.default.marketingShell,
						children: (0, b.jsxs)("div", {
							className: e.default.marketingContent,
							children: [
								(0, b.jsxs)("section", {
									className: e.default.heroCard,
									children: [
										(0, b.jsx)("p", {
										...
										(0, b.jsxs)(
											c.Card,
											{
												children: [
													...
													(0, b.jsx)("div", {
														className: e.default.heroActions,
														children: (0, b.jsx)(f, {
															href: "/sign-in",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04j6mn0._.js.map
