module.exports = [
	...
	(a) => {
		...
		a.s([
			...
			0,
			function () {
				let [a, j] = (0, c.useState)(f),
					[k, l] = (0, c.useState)([]),
					[m, n] = (0, c.useState)("https://google.com"),
					[o, p] = (0, c.useState)(""),
					[q, r] = (0, c.useState)("Starting workspace"),
					[s, t] = (0, c.useState)("Preparing session"),
					[u, v] = (0, c.useState)(null),
					[w, x] = (0, c.useState)(!1),
					[y, z] = (0, c.useState)(!1),
					[A, B] = (0, c.useState)(!1),
					C = (0, c.useDeferredValue)(m),
					D = (0, c.useRef)(null),
					E = (0, c.useRef)(null),
					F = (0, c.useRef)(null),
					G = (0, c.useRef)(null),
					...
					(0, c.useEffect)(() => {
						...
						let b = !1,
							e = async () => {
								let f,
									g =
										"function" == typeof (f = window).$scramjetLoadController &&
										f.BareMux?.BareMuxConnection
											? f
											: null;
								if (!g) {
									a = window.setTimeout(e, 120);
									return;
								}
								try {
									let a;
									if (
										(r("Starting workspace"),
									...
									(t(
										...
										r("Loading browser"));
									let { ScramjetController: e } = g.$scramjetLoadController(),
										f = new e({
											files: {
									...
									if ((await Promise.resolve(f.init()), b)) return;
									let h = new g.BareMux.BareMuxConnection("/baremux/worker.js");
									r("Connecting");
									let j = i(h, H.current);
									if (((I.current = j), await j, b)) return;
									r("Opening browser");
									let k = f.createFrame();
									((k.frame.className = d.default.proxyFrame),
										k.frame.setAttribute("title", "OmniEdu browser viewport"),
										k.frame.setAttribute(
											"allow",
											"clipboard-read; clipboard-write"
										),
										k.addEventListener("urlchange", (a) => {
											let b = a.url ?? "";
											b &&
												(0, c.startTransition)(() => {
													(p(b), n(b));
										...
										D.current?.replaceChildren(k.frame),
										await Promise.resolve(
											k.go(
												((a = `
		<!doctype html>
	...
	`),
												`data:text/html;charset=utf-8,${encodeURIComponent(a)}`)
											)
										),
										(E.current = f),
										(F.current = k),
									...
									(v(
										a instanceof Error ? a.message : "Failed to start OmniEdu."
									),
										r("Attention needed"));
								}
							};
				...
				let J = async (a = m) => {
						...
						let b = g(a);
						if (b) {
							(z(!0), v(null), r("Opening"));
							try {
								let a;
								(I.current && (await I.current),
									await Promise.resolve(F.current.go(b)),
									(a = { label: h(b), url: b }),
									(0, c.startTransition)(() => {
										l((c) => [a, ...c.filter((a) => a.url !== b)].slice(0, 6));
									}),
									(0, c.startTransition)(() => {
										(p(b), n(b));
									}),
								...
								(v(a instanceof Error ? a.message : "Navigation failed."),
									r("Navigation failed"));
							} finally {
								z(!1);
							}
					...
					K = C ? h(g(C)) : "awaiting target";
				return (0, b.jsxs)("main", {
					className: d.default.shell,
					children: [
						(0, b.jsx)("div", { className: d.default.aurora }),
						(0, b.jsxs)("section", {
							className: d.default.hero,
							children: [
								(0, b.jsxs)("div", {
									className: d.default.brandColumn,
									children: [
										(0, b.jsx)("p", {
								...
								(0, b.jsxs)("div", {
									...
									children: [
										(0, b.jsxs)("div", {
											className: d.default.metric,
											children: [
												(0, b.jsx)("span", { children: "Status" }),
												(0, b.jsx)("strong", {
													children: w ? "Ready" : "Starting",
												}),
											],
										}),
										(0, b.jsxs)("div", {
											className: d.default.metric,
											children: [
												(0, b.jsx)("span", { children: "Session" }),
												(0, b.jsx)("strong", { children: o ? "Live" : "Idle" }),
											],
										}),
										(0, b.jsxs)("div", {
											className: d.default.metric,
						...
						(0, b.jsxs)("section", {
							className: d.default.workspace,
							children: [
								(0, b.jsxs)("aside", {
									className: d.default.sidebar,
									children: [
										(0, b.jsxs)("div", {
											className: d.default.panel,
											children: [
												(0, b.jsx)("p", {
													className: d.default.panelLabel,
													children: "Launch deck",
												}),
												(0, b.jsx)("div", {
													className: d.default.quickList,
													children: e.map((a) =>
														(0, b.jsxs)(
															"button",
															{
																type: "button",
																className: d.default.quickLink,
																onClick: () => void J(a.url),
																children: [
																	(0, b.jsx)("span", { children: a.label }),
																	(0, b.jsx)("small", { children: h(a.url) }),
																],
															},
															a.url
														)
											...
											children: [
												...
												(0, b.jsx)("div", {
													...
													children:
														0 === k.length
															? (0, b.jsx)("p", {
																	className: d.default.emptyState,
																	children:
								...
								(0, b.jsxs)("section", {
									className: d.default.consoleColumn,
									children: [
										(0, b.jsxs)("div", {
											className: d.default.consolePanel,
											children: [
												(0, b.jsxs)("div", {
													className: d.default.statusRow,
													children: [
														(0, b.jsxs)("div", {
															children: [
																(0, b.jsx)("p", {
														...
														(0, b.jsxs)("div", {
															...
															children: [
																...
																(0, b.jsx)("span", {
																	className: d.default.badgeMuted,
																	children: s,
																}),
															],
														}),
													...
													children: [
														(0, b.jsxs)("div", {
															...
															children: [
																(0, b.jsx)("button", {
																	type: "button",
																	onClick: () => F.current?.back(),
																	disabled: !w,
																	children: "Back",
																}),
																(0, b.jsx)("button", {
																	type: "button",
																	onClick: () => F.current?.forward(),
																	disabled: !w,
																	children: "Forward",
																}),
																(0, b.jsx)("button", {
																	type: "button",
																	onClick: () => F.current?.reload(),
																	disabled: !w,
																	children: "Reload",
																}),
															],
														...
														(0, b.jsx)("input", {
															className: d.default.addressBar,
															value: m,
												...
												(0, b.jsxs)("div", {
													className: d.default.metaRow,
													children: [
														(0, b.jsxs)("p", {
															children: [
																"Current route:",
																(0, b.jsx)("span", { children: o || " idle" }),
															],
														}),
														(0, b.jsx)("a", {
															href: "/api/health",
												...
												u
													? (0, b.jsx)("div", {
															className: d.default.errorBanner,
															children: u,
														})
													: null,
											],
										...
										(0, b.jsxs)("div", {
											className: d.default.viewportPanel,
											children: [
												(0, b.jsxs)("div", {
													className: d.default.viewportChrome,
													children: [
														(0, b.jsx)("span", {}),
														(0, b.jsx)("span", {}),
														(0, b.jsx)("span", {}),
												...
												(0, b.jsxs)("div", {
													...
													children: [
														...
														w
															? null
															: (0, b.jsx)("div", {
																	className: d.default.loadingState,
																	children: (0, b.jsx)("p", {
																		children:
...
//# sourceMappingURL=components_01xdmwt._.js.map
