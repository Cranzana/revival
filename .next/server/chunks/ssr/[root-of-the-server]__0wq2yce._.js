	...
	(a) => {
		...
		let f = [
			...
			},
			{
				...
				summary:
					"Source validation, citation workflows, and guided browsing labs.",
			},
			{
		...
		a.s([
			...
			function () {
				return (0, b.jsx)(d.PlatformShell, {
					...
					description:
						"This view models how OmniEdu can present lessons, pathways, and operational learning programs from the same application shell.",
							...
							(0, b.jsxs)(
								c.Card,
								{
									children: [
										...
										(0, b.jsx)("h2", { children: a.title }),
										(0, b.jsx)("p", { children: a.summary }),
									],
								},
								a.title
							)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0wq2yce._.js.map
