module.exports = [
	...
	(a) => {
		...
		a.s([
			...
			0,
			function () {
				return (0, b.jsx)(d.PlatformShell, {
					eyebrow: "Administration",
					title: "Govern tenants, roles, and compliance settings",
					description:
						"Admin routes are protected by middleware and model the control plane for OmniEdu deployments.",
					children: (0, b.jsxs)("div", {
						className: e.default.grid2,
						children: [
							(0, b.jsxs)(c.Card, {
								children: [
									(0, b.jsx)("p", {
									...
									(0, b.jsx)("h2", { children: "Authentication roadmap" }),
									(0, b.jsxs)("ul", {
										children: [
											(0, b.jsx)("li", {
												children: "Access JWTs with refresh rotation helpers",
											}),
											(0, b.jsx)("li", {
												children:
													"Secure cookie conventions for session transport",
											}),
											(0, b.jsx)("li", {
												children: "MFA-ready sign-in flow scaffolding",
											}),
										],
									}),
								],
							...
							(0, b.jsxs)(c.Card, {
								children: [
									...
									(0, b.jsx)("h2", { children: "Audit and privacy controls" }),
									(0, b.jsxs)("ul", {
										children: [
											(0, b.jsx)("li", {
												children: "Prisma models include audit log entities",
											}),
											(0, b.jsx)("li", {
												children:
													"Security headers are enforced by middleware and server",
											}),
											(0, b.jsx)("li", {
												children:
													"PII-safe masking and analytics hooks can layer on this base",
											}),
										],
									}),
								],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0hfukbv._.js.map
