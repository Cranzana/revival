module.exports = [
	...
	(e) => {
		...
		e.s(["default", 0, f], 60450);
		var w = e.i(56636);
		async function E() {
			let e = await f(),
				t = (0, w.resolveRouteData)(e, "robots");
			return new m.NextResponse(t, {
				headers: {
		...
		let y = new t.AppRouteRouteModule({
			...
			{ workAsyncStorage: b, workUnitAsyncStorage: A, serverHooks: P } = y;
		async function T(e, t, a) {
			...
			let m = "/robots.txt/route";
			m = m.replace(/\/index$/, "") || "/";
			let f = await y.prepare(e, t, { srcPage: m, multiZoneDraftMode: !1 });
			if (!f)
				return (
					(t.statusCode = 400),
					t.end("Bad Request"),
			...
			let {
				...
				O = (0, i.normalizeAppPath)(m),
				U = !!(P.dynamicRoutes[O] || P.routes[q]),
				j = async () => (
			...
			if (U && !A) {
				let e = !!P.routes[q],
					t = P.dynamicRoutes[O];
				if (t && !1 === t.fallback && !e) {
					if (C.adapterPath) return await j();
					throw new R.NoFallbackError();
				}
			}
			let I = null;
			!U || y.isDev || A || (I = "/index" === (I = q) ? "/" : I);
			let H = !0 === y.isDev || !U,
				M = U && !H;
			k &&
				S &&
			...
			let D = e.method || "GET",
				...
				B = !!(null == T ? void 0 : T.isWrappedByNextServer),
				F = !!(0, n.getRequestMeta)(e, "minimalMode"),
				K =
					(0, n.getRequestMeta)(e, "incrementalCache") ||
					(await y.getIncrementalCache(e, C, P, F));
			...
			try {
					...
					i = async (n) => {
						...
						let l = async ({ previousCacheEntry: r }) => {
								try {
									...
									let i = G.renderOpts.pendingWaitUntil;
						...
						return (
							(F && U) || u.delete(v.NEXT_CACHE_TAGS_HEADER),
							!d.cacheControl ||
				...
				if (
					...
					throw t;
				return (
					await (0, c.sendResponse)(X, V, new Response(null, { status: 500 })),
					null
				);
			}
		}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0fd9j4q._.js.map
