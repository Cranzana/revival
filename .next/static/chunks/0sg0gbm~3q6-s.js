(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		let n = e.r(59929).createRenderSearchParamsFromClient;
		("function" == typeof r.default ||
			("object" == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
			(Object.defineProperty(r.default, "__esModule", { value: !0 }),
	...
	(e, t, r) => {
		...
		let n = e.r(65345).createRenderParamsFromClient;
		("function" == typeof r.default ||
			("object" == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
			(Object.defineProperty(r.default, "__esModule", { value: !0 }),
	...
	(e, t, r) => {
		...
		let n = (0, e.r(43371).createAsyncLocalStorage)();
	},
	13080,
	(e, t, r) => {
		"use strict";
			...
			return new Proxy(e, {
				get(e, n, a) {
					if ("get" === n || "getAll" === n || "has" === n) {
						let o = Reflect.get(e, n, a);
						return (n) => (
							"string" != typeof n || t.has(n) || g(O(r, n)),
							o.call(e, n)
						);
					}
					let o = Reflect.get(e, n, a);
	...
	(e, t, r) => {
				...
				switch (n.type) {
					...
					case "validation-client":
						return (function (t, r, n) {
							var a;
							let { createExhaustiveSearchParamsProxy: o } = e.r(73562);
		...
		function v(t, r, n, a) {
			...
			if (n.validationSamples) {
				let { createExhaustiveSearchParamsProxy: a } = e.r(73562),
	...
	(e, t, r) => {
					...
					case "request":
						if (s.asyncApiPromises && s.validationSamples)
							return (function (t, r, n, a, o) {
								let { createExhaustiveParamsProxy: i } = e.r(73562),
		...
		function R(t, r, n) {
			let { createExhaustiveParamsProxy: a } = e.r(73562);
			return Promise.resolve(
				a(
					t,
	...
	(e, t, r) => {
		...
		function l({ Component: t, serverProvidedParams: r }) {
			...
			if ("u" < typeof window) {
				let r,
					a,
					{ createSearchParamsFromClient: o } = e.r(35593);
				r = o(c);
				let { createParamsFromClient: i } = e.r(97017);
				return ((a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r }));
			}
			{
				let { createRenderSearchParamsFromClient: r } = e.r(81695),
					a = r(c),
					{ createRenderParamsFromClient: o } = e.r(7283),
					i = o(u);
	...
	(e, t, r) => {
		...
		function i({ Component: t, slots: r, serverProvidedParams: s }) {
			...
			if ("u" < typeof window) {
				let { createParamsFromClient: a } = e.r(97017),
					o = a(l);
				return (0, n.jsx)(t, { ...r, params: o });
			}
			{
				let { createRenderParamsFromClient: a } = e.r(7283),
					o = a(l);
				return (0, n.jsx)(t, { ...r, params: o });
			}
		}
