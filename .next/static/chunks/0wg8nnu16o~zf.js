(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e) => {
		...
		let o = [
			...
			s = "omniedu.browser.settings",
			l = "omniedu.sw.control-reload";
		function n(e) {
			return { id: e, title: "Start", url: "", faviconUrl: null };
		}
		function i() {
			return {
				...
				? r.startsWith("http://") ||
					...
					: r.includes(" ") ||
						  !(
								...
								r.startsWith("127.0.0.1") ||
								r.startsWith("[::1]") ||
								/^(?:[a-z0-9-]+\.)+[a-z]{2,}(?:[/:?#]|$)/i.test(r)
						  )
	...
	`;
			return `data:text/html;charset=utf-8,${encodeURIComponent(e)}`;
		}
		function h(e) {
			if (!e) return "Start";
			try {
		...
		function b(e) {
			...
			try {
				...
				if ("http:" === r.protocol || "https:" === r.protocol)
					return new URL("/favicon.ico", r.origin).toString();
			} catch {}
			return null;
		}
		function m() {
		...
		async function C(e = 2500) {
			return navigator.serviceWorker.controller ||
				(await new Promise((r) => {
					let t = window.setTimeout(() => {
						(navigator.serviceWorker.removeEventListener("controllerchange", a),
							r(!1));
					}, e);
					function a() {
					...
					navigator.serviceWorker.addEventListener("controllerchange", a);
				}))
				? (window.sessionStorage.removeItem(l), !0)
				: (window.sessionStorage.getItem(l) ||
						(window.sessionStorage.setItem(l, "1"), window.location.reload()),
					!1);
		}
		e.s([
			"BrowserHub",
			...
			function () {
				let [e, l] = (0, t.useState)(null),
					[v, j] = (0, t.useState)([n("tab-1")]),
					[g, y] = (0, t.useState)("tab-1"),
					[Q, X] = (0, t.useState)(""),
					[L, N] = (0, t.useState)(!0),
					[B, S] = (0, t.useState)("waiting"),
					[$, M] = (0, t.useState)(!1),
					[T, F] = (0, t.useState)(!0),
					[H, R] = (0, t.useState)(!1),
					[U, V] = (0, t.useState)(!1),
					...
					G = (0, t.useRef)(null),
					D = (0, t.useRef)(null),
					J = (0, t.useRef)(new Map()),
					K = (0, t.useRef)(null),
					Z = (0, t.useRef)(null),
					q = (0, t.useRef)(2),
					Y = (0, t.useRef)(g),
					ee = (0, t.useMemo)(() => v.find((e) => e.id === g) ?? v[0], [v, g]),
					er = ee?.url ?? "",
					et = ee?.title ?? "Start",
					ea = (function (e) {
						switch (e) {
				...
				((0, t.useEffect)(() => {
					z.current = window.performance.now();
				}, []),
					(0, t.useEffect)(() => {
						let e;
						if (!$ && !A) return;
						let r = z.current ?? window.performance.now(),
							t = Math.max(0, 900 - (window.performance.now() - r)),
							a = window.setTimeout(() => {
								(R(!0), (e = window.setTimeout(() => F(!1), 220)));
							}, t);
						return () => {
							(window.clearTimeout(a), e && window.clearTimeout(e));
						};
					}, [$, A]),
					(0, t.useEffect)(() => {
						Y.current = g;
					...
					(0, t.useEffect)(() => {
						e && window.localStorage.setItem(s, JSON.stringify(e));
					}, [e]),
					(0, t.useEffect)(() => {
						X(er);
					}, [er]));
				let eo = (e, r) => {
						(O((r) => {
							...
							j((t) =>
								t.map((t) =>
									t.id === e
										? { ...t, url: r, title: h(r), faviconUrl: b(r) }
										: t
								)
							));
					},
					es = (e) => {
						for (let [r, t] of J.current.entries())
							t.frame.className =
								r === e
									? `${a.default.proxyFrame} ${a.default.proxyFrameActive}`
									: `${a.default.proxyFrame} ${a.default.proxyFrameHidden}`;
					},
					el = (e) => J.current.get(e) ?? null,
					en = async (e) => {
						if (!K.current || !G.current) return null;
						let r = el(e.id);
						if (r) return r;
						let o = K.current.createFrame();
						return (
							(o.frame.className = `${a.default.proxyFrame} ${a.default.proxyFrameHidden}`),
							o.frame.setAttribute("title", `OmniEdu workspace ${e.id}`),
							o.frame.setAttribute("allow", "clipboard-read; clipboard-write"),
							o.addEventListener("urlchange", (r) => {
								let a = r.url ?? "";
								!a ||
									a.startsWith("data:text/html") ||
									(0, t.startTransition)(() => {
										(eo(e.id, a), Y.current === e.id && X(a));
									});
							}),
							G.current.appendChild(o.frame),
							J.current.set(e.id, o),
							e.url
								? await Promise.resolve(o.go(e.url))
								: await Promise.resolve(o.go(c())),
							o
						);
					},
					ei = async (e) => {
						!$ || (P(null), (await en(e)) && es(e.id));
					};
				(0, t.useEffect)(() => {
					let r;
					if (!e) return;
					let t = !1,
						a = async () => {
							let o,
								s =
									"function" == typeof (o = window).$scramjetLoadController &&
									o.BareMux?.BareMuxConnection
										? o
										: null;
							if (!s) {
								r = window.setTimeout(a, 120);
								return;
							}
							try {
								if (
								...
								S("claiming");
								let r = await C();
								if (t || !r) return void P("Worker control never attached.");
								S("attached");
								let { ScramjetController: a } = s.$scramjetLoadController(),
									o = new a({
										files: {
								...
								if ((await Promise.resolve(o.init()), t)) return;
								let l = new s.BareMux.BareMuxConnection("/baremux/worker.js"),
									i = u(l, e);
								if (((Z.current = i), await i, t)) return;
								((K.current = o),
									P(null),
									M(!0),
									await en(n("tab-1")),
									es("tab-1"),
									window.setTimeout(() => D.current?.focus(), 0));
							} catch (e) {
								P(e instanceof Error ? e.message : "Failed to initialize.");
							}
						};
					return (
						a(),
				...
				let ed = async (e = Q) => {
						...
						if (r) {
							...
							try {
								...
								if (!e) return;
								(es(ee.id),
									await Promise.resolve(e.go(r)),
									(0, t.startTransition)(() => {
										(eo(ee.id, r), X(r));
									}));
							} catch (e) {
								P(e instanceof Error ? e.message : "Navigation failed.");
							} finally {
								V(!1);
							}
						}
					...
					eu = async () => {
						...
						(j((e) => [...e, r]),
							...
							X(""),
							$ &&
								(await ei(r), window.setTimeout(() => D.current?.focus(), 0)));
					},
					ec = async (e) => {
						if (!$) return;
						let r = d(e.url),
							t = `tab-${q.current++}`,
							a = { id: t, title: h(r), url: r, faviconUrl: b(r) };
						(j((e) => [...e, a]), (Y.current = t), y(t), X(r), V(!0), P(null));
						try {
							(Z.current && (await Z.current), await ei(a));
						} catch (e) {
							P(e instanceof Error ? e.message : "Shortcut failed to open.");
						} finally {
							V(!1);
						}
					},
					eh = async (e) => {
						if (e === g) return;
						let r = v.find((r) => r.id === e);
						r && ((Y.current = e), y(e), X(r.url), await ei(r));
					},
					eb = async (e) => {
						if (1 === v.length) {
							let r = n(e);
							(j([r]),
								...
								y(e),
								X(""),
								J.current.get(e)?.frame.remove(),
								J.current.delete(e),
								await ei(r),
								window.setTimeout(() => D.current?.focus(), 0));
							return;
						}
						let r = v.findIndex((r) => r.id === e);
						if (-1 === r) return;
						let t = v.filter((r) => r.id !== e),
							a = t[Math.max(0, r - 1)];
						(J.current.get(e)?.frame.remove(),
							J.current.delete(e),
							O((r) => {
							...
							g === e &&
								a &&
								((Y.current = a.id), y(a.id), X(a.url), await ei(a)));
					},
					em = async () => {
						if (!ee) return;
						let e = { ...ee, title: "Start", url: "", faviconUrl: null };
						(j((r) => r.map((r) => (r.id === ee.id ? e : r))),
							O((e) => {
								if (!(ee.id in e)) return e;
								let r = { ...e };
								return (delete r[ee.id], r);
							}),
							X(""));
						let r = el(ee.id);
						(r && (es(ee.id), await Promise.resolve(r.go(c()))),
							window.setTimeout(() => D.current?.focus(), 0));
					};
				return (0, r.jsxs)("div", {
					className: a.default.shell,
					children: [
						(0, r.jsx)("div", { className: a.default.shellGlow }),
						T
							? (0, r.jsx)("div", {
									className: `${a.default.splash} ${H ? a.default.splashLeaving : ""}`,
									role: "status",
									"aria-live": "polite",
									"aria-label": ea,
									children: (0, r.jsxs)("div", {
										className: a.default.splashCard,
										children: [
											(0, r.jsx)("img", {
												src: "/assets/omniedu-logo.png",
												alt: "",
												className: a.default.splashLogo,
											}),
											(0, r.jsx)("div", {
												className: a.default.splashWordmark,
												children: "OmniEdu",
											}),
											(0, r.jsx)("div", {
												className: a.default.splashTrack,
							...
							: null,
						(0, r.jsxs)("div", {
							className: `${a.default.frame} ${L ? a.default.frameExpanded : a.default.frameCollapsed}`,
							children: [
								(0, r.jsxs)("aside", {
									className: `${a.default.sidebar} ${L ? "" : a.default.sidebarCollapsed}`,
									children: [
										(0, r.jsxs)("div", {
											className: a.default.sidebarHeader,
											children: [
												(0, r.jsxs)("div", {
													className: `${a.default.sidebarHeading} ${L ? "" : a.default.sidebarHeadingHidden}`,
													children: [
														(0, r.jsx)("p", {
															className: a.default.sidebarEyebrow,
															children: "library",
														}),
														(0, r.jsx)("h2", { children: "Tabs" }),
													],
												}),
												(0, r.jsxs)("div", {
													className: a.default.sidebarActions,
													children: [
														(0, r.jsx)("button", {
															type: "button",
															className: a.default.sidebarToggleButton,
															onClick: () => {
																N((e) => !e);
															},
															"aria-label": L ? "Collapse tabs" : "Expand tabs",
															"aria-pressed": !L,
															children: (0, r.jsx)(p, { collapsed: !L }),
														}),
														(0, r.jsx)("button", {
															type: "button",
															className: a.default.newTabButton,
															onClick: () => void eu(),
															disabled: !$,
										...
										(0, r.jsx)("div", {
											className: a.default.tabList,
											children: v.map((e) =>
												(0, r.jsxs)(
													"div",
													{
														className: `${a.default.tabCard} ${e.id === g ? a.default.tabCardActive : ""}`,
														children: [
															(0, r.jsxs)("button", {
																type: "button",
																className: a.default.tabCardButton,
																onClick: () => void eh(e.id),
																title: e.url
																	? `${e.title} - ${e.url}`
																	: e.title,
																children: [
																	(0, r.jsx)("div", {
																		className: a.default.tabCardBadge,
																		children:
																			e.faviconUrl && !I[e.id]
																				? (0, r.jsx)("img", {
																						src: e.faviconUrl,
																						alt: "",
																						className: a.default.tabFavicon,
																						onError: () =>
																							O((r) => ({ ...r, [e.id]: !0 })),
																					})
																	...
																	(0, r.jsxs)("div", {
																		className: `${a.default.tabCardText} ${L ? "" : a.default.tabCardTextHidden}`,
																		children: [
																			(0, r.jsx)("strong", {
																				children: e.title,
																			}),
																			(0, r.jsx)("span", {
																				children: e.url ? e.url : "start page",
																			}),
																		],
																	}),
																],
															...
															(0, r.jsx)("button", {
																type: "button",
																className: a.default.tabCloseButton,
																onClick: () => void eb(e.id),
										...
										(0, r.jsx)("div", {
											className: a.default.shortcutDock,
											...
											children: o.map((e) =>
												(0, r.jsx)(
													...
													{
														type: "button",
														className: a.default.shortcutButton,
														onClick: () => void ec(e),
														disabled: !$ || U,
														title: e.label,
														"aria-label": `Open ${e.label}`,
														children: (0, r.jsx)(W, { kind: e.kind }),
													},
													e.kind
												)
											),
								...
								(0, r.jsxs)("section", {
									className: `${a.default.browser} ${er ? a.default.browserFocused : ""}`,
									children: [
										(0, r.jsxs)("header", {
											className: `${a.default.chrome} ${er ? a.default.chromeFocused : ""}`,
											children: [
												(0, r.jsxs)("div", {
													className: a.default.chromeBrand,
													children: [
														(0, r.jsx)("img", {
															src: "/assets/omniedu-logo.png",
															alt: "",
														}),
														(0, r.jsx)("span", { children: "OmniEdu" }),
													],
												}),
												(0, r.jsx)("div", {
													className: a.default.currentTabPill,
													children: et,
												}),
											],
										}),
										(0, r.jsxs)("div", {
											className: `${a.default.toolbar} ${er ? a.default.toolbarFocused : ""}`,
											children: [
												(0, r.jsxs)("div", {
													className: a.default.navButtons,
													children: [
														(0, r.jsx)("button", {
															type: "button",
															className: a.default.iconButton,
															onClick: () => el(g)?.back(),
															disabled: !er,
															"aria-label": "Go back",
															children: (0, r.jsx)(m, {}),
												...
												(0, r.jsxs)("form", {
													className: a.default.addressForm,
													onSubmit: (e) => {
														(e.preventDefault(), ed());
													},
													children: [
														(0, r.jsx)("span", {
															className: a.default.addressPrefix,
															children: "*",
														}),
														(0, r.jsx)("input", {
															value: Q,
												...
												(0, r.jsxs)("div", {
													className: a.default.toolbarActions,
													children: [
														(0, r.jsx)("button", {
															type: "button",
															className: a.default.metaButton,
															onClick: () => void em(),
															disabled: !$,
										...
										(0, r.jsxs)("div", {
											className: `${a.default.workspace} ${er ? a.default.workspaceFocused : ""}`,
											children: [
												(0, r.jsx)("div", {
													className: `${a.default.launcherView} ${er ? a.default.launcherViewHidden : ""}`,
													children: (0, r.jsxs)("div", {
														className: a.default.launcherInner,
														children: [
															(0, r.jsxs)("div", {
																className: a.default.brandRow,
																children: [
																	(0, r.jsx)("img", {
																		src: "/assets/omniedu-logo.png",
																		alt: "",
																	...
																	(0, r.jsxs)("div", {
																		children: [
																			(0, r.jsx)("p", {
																				className: a.default.brandLabel,
																				children: "OmniEdu",
																			}),
																			(0, r.jsx)("h1", {
															...
															(0, r.jsxs)("form", {
																...
																children: [
																	(0, r.jsx)("span", {
																		className: a.default.heroSearchIcon,
																		children: "/",
																	}),
																	(0, r.jsx)("input", {
																		ref: D,
																	...
																	(0, r.jsx)("button", {
																		type: "submit",
																		disabled: !$ || U,
																		children: U ? "loading" : "go",
																	}),
																],
															}),
															A
																? (0, r.jsx)("div", {
																		className: a.default.errorRow,
																		children: A,
																	})
																: null,
														],
												...
												(0, r.jsx)("div", {
													className: `${a.default.liveView} ${er ? a.default.liveViewVisible : ""}`,
													children: (0, r.jsx)("div", {
														className: `${a.default.viewportShell} ${er ? a.default.viewportShellFocused : ""}`,
														children: (0, r.jsx)("div", {
															ref: G,
												...
												$
													? null
													: (0, r.jsx)("div", {
															className: a.default.loadingOverlay,
															children: (0, r.jsx)("p", { children: ea }),
														}),
											],
										}),
									],
