	...
	(e, t, r) => {
		...
		function g(t) {
			...
			let o,
				u,
				g,
				[m, _] = (0, a.useOptimistic)(h.IDLE_LINK_STATUS),
				P = (0, a.useRef)(null),
				{
					href: j,
					as: O,
			...
			let q = A ? u && "object" == typeof u && u.ref : K,
				z = a.default.useCallback(
					(e) => (
						null !== B &&
							(P.current = (0, h.mountLinkInstance)(e, F, B, N, D, _)),
						() => {
							(P.current &&
				...
				W = {
							...
							!B ||
								...
								(function (t, r, n, o, u, l, i) {
									if ("u" > typeof window) {
										...
										let { dispatchNavigateAction: s } = e.r(53385);
					...
					onMouseEnter(e) {
						(A || "function" != typeof U || U(e),
							...
							B && D && (0, h.onNavigationIntent)(e.currentTarget, !0 === $));
					},
			...
			return (
				(0, s.isAbsoluteUrl)(F)
					? (W.href = F)
					: (A && !C && ("a" !== u.type || "href" in u.props)) ||
						(W.href = (0, p.addBasePath)(F)),
				(g = A
					? a.default.cloneElement(u, W)
					: (0, l.jsx)("a", { ...w, ...W, children: o })),
				(0, l.jsx)(v.Provider, { value: m, children: g })
			);
		}
		e.r(98904);
