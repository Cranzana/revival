...
- Build the unified Next.js app and Scramjet runtime with `pnpm build`

### Running Scramjet Locally

You can run the unified Next.js and Scramjet dev server with the command

```sh
pnpm dev
```

The web interface should now be running at <http://localhost:3000> and will serve the Next.js console, Scramjet bundles, Bare endpoints, and Wisp transport from the same origin.
...
The unified app also exposes a simple health check at <http://localhost:3000/api/health>.
